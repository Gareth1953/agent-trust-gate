...
- [ ] P3-M145 end-to-end GatePass pilot and commercial conversion pack is present: [end-to-end GatePass pilot](docs/end-to-end-gatepass-pilot.md), [commercial feasibility pilot](docs/commercial-feasibility-pilot.md), [pilot inputs, outputs and boundaries](docs/pilot-inputs-outputs-boundaries.md), [pilot conversion path](docs/pilot-conversion-path.md), [pilot report](examples/end-to-end-gatepass-pilot-report.json), and `npm run demo:gatepass-pilot`.
- [ ] P3-M144 embedded commerce GatePass demonstrator is present: [Embedded Commerce GatePass](docs/embedded-commerce-gatepass.md), [Embedded Commerce design-partner pilot](docs/embedded-commerce-design-partner-pilot.md), [commerce report](examples/embedded-commerce-gatepass-report.json), and `npm run demo:commerce-gatepass`.
- [ ] P3-M144A embedded commerce commercial positioning is present on the static discovery homepage and in discovery metadata, while Agent Trust Gate remains a broad trust layer rather than a supermarket-only product.
...
- [ ] P3-M143A passive discovery activation record is present: [GitHub Pages passive discovery activation](docs/github-pages-passive-discovery-activation.md), [live verification checklist](docs/passive-discovery-live-verification-checklist.md), [repository social preview upload](docs/repository-social-preview-upload.md), [activation record](docs/passive-discovery-activation-record.md), [activation record template](docs/passive-discovery-activation-record-template.md), [Pages deployment workflow](.github/workflows/deploy-discovery-pages.yml), and `npm run validate:discovery-site`.
...
- [ ] P3-M131 agent proof contract integration readiness pack is present: [agent proof contract integration readiness](docs/agent-proof-contract-integration-readiness.md), [local agent workflow integration guide](docs/local-agent-workflow-integration-guide.md), [tool-calling proof gate adapter guide](docs/tool-calling-proof-gate-adapter-guide.md), [pre-settlement proof contract integration](docs/pre-settlement-proof-contract-integration.md), and [integration readiness checklist](docs/integration-readiness-checklist.md).
- [ ] P3-M132 enforceable local tool-calling gate demo is present: [enforceable local tool-calling gate demo](docs/enforceable-local-tool-calling-gate-demo.md), [local tool-call gate wrapper guide](docs/local-tool-call-gate-wrapper-guide.md), [mock sensitive tools catalog](docs/mock-sensitive-tools-catalog.md), [tool-call enforcement scenarios](docs/tool-call-enforcement-scenarios.md), and [what the enforceable tool gate demo proves](docs/what-the-enforceable-tool-gate-demo-proves.md).
...
- [ ] P3-M143 does not add payment integration, checkout, payment links, PayPal or Stripe code, live invoices, payment credentials, payment processing, or settlement execution.
- [ ] P3-M143A does not add payment integration, checkout, payment links, PayPal or Stripe code, live invoices, payment credentials, payment processing, or settlement execution.
- [ ] P3-M144 embedded commerce wording is local and synthetic only, with no live retailer integration, shopping-agent integration, checkout, account login, card handling, payment token handling, payment processing, settlement execution, AI-provider integration, network calls, A2A service, MCP service, or production integration.
- [ ] P3-M144A embedded commerce positioning makes commercial relevance clear without claiming named-company affiliation, live retailer deployment, checkout control, payment processing, production readiness, guaranteed protection, or supermarket-only scope.
- [ ] P3-M145 GatePass pilot wording remains local and simulated only, with no live payment processing, real settlement, external API, network call, customer data, credential, production key, blockchain or cryptocurrency logic, live MCP proxy, SSO, production deployment, autonomous financial execution, or action execution.
