...
- [ ] P3-M143 passive discovery activation preparation is present: [GitHub Pages passive discovery activation](docs/github-pages-passive-discovery-activation.md), [live verification checklist](docs/passive-discovery-live-verification-checklist.md), [repository social preview upload](docs/repository-social-preview-upload.md), [activation record template](docs/passive-discovery-activation-record-template.md), [Pages deployment workflow](.github/workflows/deploy-discovery-pages.yml), and `npm run validate:discovery-site`.
