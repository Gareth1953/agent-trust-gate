...
export type { AtgPrototypeCheck,AtgPrototypeCheckStatus,AtgPrototypeDecision,BoundedProcurementMandate,ExactActionPrototypeEvaluation,ExactActionPrototypeExecutionResult,ExactActionPrototypeFaults,ExactActionPrototypeScenarioId,ExactActionPrototypeScenarioInput,ExactActionPrototypeScenarioPreview,ExactActionPrototypeSmokeResult,ExactActionTrustReceipt,ExactActionTrustReceiptIntegrity,HumanAuthenticationFixture,HumanAuthorityEmployeeFixture,HumanAuthorityProof,HumanPurchasePermission,ProcurementEvidenceRecord,ProcurementOffer,ProposedProcurementAction,PrototypeExecutionRecord,PrototypeExecutionStatus,PrototypePrimaryFailure,PrototypePrimaryFailureCode,ReceiptExecutiveSummary,StructuredPrototypeRefusal,TrustReceiptVerification } from "./exact-action-trust-gateway-prototype.js";
