...
P3-M132 update: agent-readable discovery now includes the enforceable local
tool-calling gate demo, safe command, docs, examples, and no-real-tool-execution
